...
class Page2_1(Page):
    ...
    def error_message(player, values):
        ...
        if values['maindeployment_start_year']<(2026-participant.age) and (values['maindeployment_start_year']!=998 and values['maindeployment_start_year']!=999):
            return 'Start year (3.2.4.) greater than respondent birth year'
        if values['seconddeployment_start_year']<(2026-participant.age) and (values['seconddeployment_start_year']!=998 and values['seconddeployment_start_year']!=999):
            return 'Start year (3.2.9.) greater than respondent birth year'
        if values['military_province_second'] == values['military_province_main'] and values['military_province_second']!=11:
...
class Page2_2(Page):
    ...
    def error_message(player, values):
        ...
        if values['noncombatant_geography_second_b'] == 1:
            ...
            if values['noncombatant_geography_second'] == values['noncombatant_geography_main'] and values['noncombatant_geography_second']!=11:
