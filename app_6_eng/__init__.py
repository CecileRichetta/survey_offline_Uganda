...
class C(BaseConstants):
    ...
    TOKEN_ENDOWMENT = 4
    CHOICES_PG = [
        (0, 'I want to keep all my 4 tokens.'), # I want to keep all my 4 tokens.
        (1, "I want to keep 3 tokens and contribute 1 token to the common bag."), # I want to keep 3 tokens and contribute 1 token to the group bag.
        (2, "I want to keep 2 tokens and contribute 2 tokens to the common bag."), # I want to keep 2 tokens and contribute 2 tokens to the group bag.
        (3, "I want to keep 1 token and contribute 3 tokens to the common bag."), # I want to keep 1 token and contribute 3 tokens to the group bag.
        (4, "I want to keep nothing and contribute all 4 tokens to the common bag.") # I want to keep nothing and contribute all 4 tokens to the group bag.
    ]
    ...
    TEMPLATE_INSTRUCTIONS_ULTIMATUM_RESPONDER = '_static/texts_ENGLISH/instr_ultimatum_receiver.html'
...
class Player(BasePlayer):
    ...
    pg_cc1 = models.IntegerField(
        label="6.1. I can decide to put zero token in the common bag.",
    ...
    pg_cc2 = models.IntegerField(
        label="6.2. The other person knows how much I put in the common bag before making their decision.",
    ...
    pg_cc3 = models.IntegerField(
        label="6.3. The other person is fake.",
    ...
    pg_redo_questions = models.BooleanField(
        label="6.4. Some of your answers in the previous questions were not correct. I want to give you the opportunity to listen once more to the full instructions, and answer the questions. Do you want to listen the instructions and answer once again the questions?",
        # Some of your answers in the previous questions were not correct. I want to give you the opportunity to listen
    ...
    risk_aversion = models.IntegerField(
        label="6.5. How much do you agree with the following statement: Generally speaking, I am person fully prepared to take risks (Read options out).",
    ...
    time_preference_6m = models.StringField(
        label="6.6. Imagine you could choose between receiving 100'000 Ugandan shilling immediately, or another amount 6 months from now. How much would the future amount need to be to make it as attractive as receiving 100'000 Ugandan shilling immediately?",
    ...
    time_preference_1y = models.StringField(
        label="6.7. Imagine you could choose between receiving 100'000 Ugandan shilling immediately, or another amount 1 year from now. How much would the future amount need to be to make it as attractive as receiving 100'000 Ugandan shilling immediately?",        # Imagine you could choose between receiving $300 immediately, or another amount 1 year from now. How much would the future amount need to be to make it as attractive as receiving $300 immediately?
        blank=False
    )
    time_preference_10y = models.StringField(
        label="6.8. Imagine you could choose between receiving 100'000 Ugandan shilling immediately, or another amount 10 years from now. How much would the future amount need to be to make it as attractive as receiving 100'000 Ugandan shilling immediately?",        # Imagine you could choose between receiving $300 immediately, or another amount 10 years from now. How much would the future amount need to be to make it as attractive as receiving $300 immediately?
        blank=False
    )
    #
