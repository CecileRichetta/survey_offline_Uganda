...
class Player(BasePlayer):
    ...
    social_trust_wvs = models.IntegerField(
        label="8.1. Generally speaking, would you say that most people can be trusted or would you say it’s necessary to be very cautious when dealing with most people?",
    ...
    social_trust_wallet = models.IntegerField(
        label="8.2. Suppose you lost your purse/wallet containing your address details, and it was found in the street by someone living in your neighborhood. How likely is it that it would be returned to you with nothing missing?",        # Suppose you lost your purse/wallet containing your address details, and it was found in the street by "
    ...
    social_trust_2 = models.IntegerField(
        label="8.3.  Please tell me how much you trust: your family.",
    ...
    social_trust_3 = models.IntegerField(
        label="8.4. Please tell me how much you trust: your neighbors?",
    ...
    institutional_trust_1 = models.IntegerField(
        label="8.11. Please tell me how much you trust the following institution: The president.",
        # The president
        choices=C.TRUST_SCALE,
        widget=widgets.RadioSelect,
        blank=False
    ...
    institutional_trust_2 = models.IntegerField(
        label="8.12. Please tell me how much  you trust the following institution: The parliament.",
        # The parliament
        choices=C.TRUST_SCALE,
        widget=widgets.RadioSelect,
        blank=False
    ...
    institutional_trust_7 = models.IntegerField(
        label="8.13. Please tell me how much you trust the following institution: The police.",
        # The Police
        choices=C.TRUST_SCALE,
        widget=widgets.RadioSelect,
        blank=False
    ...
    institutional_trust_8 = models.IntegerField(
        label="8.14. Please tell me how much you trust the following institution: The military.",
        # The army
        choices=C.TRUST_SCALE,
        widget=widgets.RadioSelect,
        blank=False
    ...
    institutional_trust_9 = models.IntegerField(
        label="8.15. Please tell me how much you trust the following institution: The courts of law.",
        # The courts of law
        choices=C.TRUST_SCALE,
        widget=widgets.RadioSelect,
        blank=False
    ...
    institutional_trust_10 = models.IntegerField(
        label="8.16. Please tell me how much you trust the following institution: The traditional leaders.",
