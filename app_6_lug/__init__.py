...
class C(BaseConstants):
    ...
    TOKEN_ENDOWMENT = 4
    CHOICES_PG = [
        (0, 'Njagala okukuuma token zange bwonna 4.'), # I want to keep all my 4 tokens.
        (1, "Njagala okukuuma tokens 3 n'okuwaayo 1 token ku nsawo eya bulijjo."), # I want to keep 3 tokens and contribute 1 token to the group bag.
        (2, "Njagala okukuuma tokens 3 n'okuwaayo 1 token ku nsawo eya bulijjo."), # I want to keep 2 tokens and contribute 2 tokens to the group bag.
        (3, "Njagala okukuuma 1 token n'okuwaayo tokens 3 ku nsawo eya bulijjo."), # I want to keep 1 token and contribute 3 tokens to the group bag.
        (4, "Njagala obutaba na kintu kyonna era n’okuwaayo token zonna 4 ku nsawo eya bulijjo.") # I want to keep nothing and contribute all 4 tokens to the group bag.
    ]
    # FILE PATH TREATMENT BALANCE TABLE
    FILE_PATH_TREATMENT = '_static/data_external/treatment_balance.csv'
    # INSTRUCTIONS TEMPLATES
    TEMPLATE_INSTRUCTIONS_ULTIMATUM_PROPOSER = '_static/texts_LUGANDA/instr_ultimatum_proposer.html'
    TEMPLATE_INSTRUCTIONS_ULTIMATUM_RESPONDER = '_static/texts_LUGANDA/instr_ultimatum_receiver.html'
    TEMPLATE_INSTRUCTIONS_PG = '_static/texts_LUGANDA/instr_pg.html'
    # IMAGES TEMPLATES
...
class Player(BasePlayer):
    ...
    pg_cc1 = models.IntegerField(
        label="6.1. Nsobola okusalawo obutatekamu mu nsawo.",
    ...
    pg_cc2 = models.IntegerField(
        label="6.2.  Omuntu oli amanya omuwendo ggwentaddemu mu nsawo nga nakola kusalawo.",
    ...
    pg_cc3 = models.IntegerField(
        label="6.3. Omuntu oli si mutuufu.",
    ...
    pg_redo_questions = models.BooleanField(
        label="6.4. Ebimu ku byozeemu ku bibuuzo ebiyise si bituufu. Njagala kuwa omukisa okuwuliriza omundi gumu okusingawo "
              "ku byolina ogoberera, oddemu ebibuuzo. Oyagala okuwuliriza ebigobererwa oddemu ebibuuzo neera? ่",
    ...
    risk_aversion = models.IntegerField(
        label="6.5. Okirizinganya kyenkana kyi ne sitetimentinzinno wammanga: Okutwaliza awamu ndi muntu omwetegefu okwetaba mu mbeera ezirisikinga. (Enumetaror Note: Pse readout options out loud)",
    ...
    time_preference_6m = models.StringField(
        label="6.6. Kuba akafananyi ngolina okulondawo wakati wokufuna 100,000 eza Uganda mubwangu, oba emyezi 6 okuva kati. Muwendo kyi ogwo mu maaso bweguyinza okuba kusikiriza  ngo okufuna e mitwalo 100,000 zotwaala mu bwangu.",
    ...
    time_preference_1y = models.StringField(
        label="6.7. Kuba akafananyi ngolina okulondawo ku mitwalo 100,000 eza Uganda mu bwangu oba omuwendo omulala omwaka gumu okuva kati. Muwendo kyi ogwo mu maaso bwegulina okuba okukusikiriza okufuna emitwalo 100,000 eza Uganda  mu bwangu.",
    ...
    time_preference_10y = models.StringField(
        label="6.8. Kuba akafananyi ngolina okulondawo ku mitwalo 100,000 eza Uganda mu bwangu oba omuwendo omulala mu myaka kumi okuva kati. Muwendo kyi ogwo mu maaso bwegulina okuba okukusikiriza okufuna emitwalo 100,000 eza Uganda  mu bwangu.",
