...
class C(BaseConstants):
    ...
    TOKEN_ENDOWMENT = 4
    CHOICES_UG_PROPOSER = [
        (0, "Sijja kuwa munnange tokens, naye byonna 4 nja kubikuuma ku lwange."),
        (1, 'Njagala okuwa 1 token eri munnange era nkuume 3 ku lwange.'),
        (2, 'Njagala okuwa 2 tokens eri munnange era nkuume 2 ku lwange.'),
        (3, "Njagala okuwa 3 tokens eri munnange n'okukuume 1 ku lwange."),
        (4, "Njagala okuwa munnange tokens 4 n’okukuume ku lwange.")
    ]
    CHOICES_UG_RECEIVER = [
        (0, 'Nzikiriza nti sifuna kintu kyonna, era omuntu omulala akuuma obubonero bwonna 4.'),
        (1, 'Nkiriza offer singa omuntu omulala ansindika 1 token nebakuuma tokens 3.'),
        (2, 'Nkiriza offer singa omuntu omulala ansindika tokens 2 nebakuuma 2 tokens.'),
        (3, 'Nkiriza offer singa omuntu omulala ansindika tokens 3 nebakuuma 1 token.'),
        (4, 'Nkiriza offer singa omuntu omulala ansindika tokens 4 nga tebalina kyebakuuma.')
    ]
    # INSTRUCTIONS TEMPLATES
    TEMPLATE_INSTRUCTIONS_ULTIMATUM_PROPOSER = '_static/texts_LUGANDA/instr_ultimatum_proposer.html'
    TEMPLATE_INSTRUCTIONS_ULTIMATUM_RECEIVER = '_static/texts_LUGANDA/instr_ultimatum_receiver.html'
...
class Player(BasePlayer):
    ...
    ultimatum_redo_questions = models.BooleanField(
        label="5.3. Ebimu ku byozeemu ku bibuuzo ebiyise si bituufu. Njagala kuwa omukisa okuwuliriza omundi gumu okusingawo "
              "ku byolina ogoberera, oddemu ebibuuzo. Oyagala okuwyliriza ebigobererwa oddemu ebibuuzo neera? ",
    ...
    ug_proposer_cc1 = models.IntegerField(
        label="5.1.1. Sirina kyakulondako wabula okuwa akasiimo eri alina okafuna.",
    ...
    ug_proposer_cc2 = models.IntegerField(
        label="5.1.2. Afuna asobola okugaana ekimuwereddwa.",
    ...
    ug_receiver_cc1 = models.IntegerField(
        label="5.2.1. Agaba talina kyakusalawo wabula okunsindikira akasiimo.",
    ...
    ug_receiver_cc2 = models.IntegerField(
        label="5.2.2. Bwekiba nga akasiimo kensabye katono kwekyo agaba kyampadde, Nfuna obusiimo.",
